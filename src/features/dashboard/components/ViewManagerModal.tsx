...
export function ViewManagerModal({ manager, onClose }: ViewManagerModalProps) {
  return (
    <AnimatePresence>
      {manager && (
          ...
          >
            ...
            <div className="text-center mb-6">
              <div className="w-16 h-16 rounded-2xl bg-emerald-50 flex items-center justify-center mx-auto mb-3">
                <span className="text-2xl font-bold text-emerald-600">{manager.name.charAt(0)}</span>
              </div>
            ...
            <div className="space-y-3">
              {[
                ...
                { label: "Created", value: manager.createdAt },
              ].map((item) => (
