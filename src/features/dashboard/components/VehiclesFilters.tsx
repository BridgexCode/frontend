...
export function VehiclesFilters({
  ...
  typeFilter, onTypeFilterChange, loading, onRefresh, onCreateClick,
    ...
    <>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5">Manage fleet vehicles and maintenance</p>
        </div>
      ...
      <div className="bg-white border border-slate-100 rounded-2xl p-4 space-y-3">
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Search by plate number, model, driver..."
              value={search}
          ...
          {showFilters && (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <select value={typeFilter} onChange={(e) => onTypeFilterChange(e.target.value)} className="border border-slate-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-emerald-600 bg-white font-medium cursor-pointer">
