...
const quickActions = [
  { label: "Create Worker", icon: UserPlus, color: "bg-blue-500" },
  { label: "Create Shipment", icon: Package, color: "bg-indigo-500" },
  { label: "Assign Shipment", icon: UserCheck, color: "bg-emerald-500" },
  { label: "View Timeline", icon: Clock, color: "bg-amber-500" },
];
