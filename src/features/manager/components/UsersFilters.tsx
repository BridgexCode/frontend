...
export function UsersFilters({
  ...
  statusFilter, onStatusFilterChange, loading, onRefresh, onCreateClick,
}: UsersFiltersProps) {
    ...
    <>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5">Manage all users in your organization</p>
        </div>
          ...
          {showFilters && (
            ...
            >
              <div className="space-y-1">
                ...
                <select value={roleFilter} onChange={(e) => onRoleFilterChange(e.target.value)} className="border border-slate-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-emerald-600 bg-white font-medium cursor-pointer">
